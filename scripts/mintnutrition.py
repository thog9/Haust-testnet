...
CONTRACT_ADDRESS = "0x28e50a3632961dA179b2Afca4675714ea22E7BB7"  # NFT2 - Nutrition Medium NFT
CONTRACT_ABI = [
    {
...
LANG = {
    'vi': {
        'title': 'MINT NFT - NUTRITION MEDIUM NFT - HAUST TESTNET',
        'info': 'Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        ...
        'success': 'Mint NFT Nutrition Medium thành công!',
    ...
    'en': {
        ...
        'success': 'Successfully minted Nutrition Medium NFT!',
        'failure': 'Mint failed',
        'address': 'Address',
        'gas': 'Gas',
        'block': 'Block',
...
# Hàm chính
async def run_mintnutrition(language: str = 'en'):
    print()
...
if __name__ == "__main__":
    asyncio.run(run_mintnutrition('en'))
