...
LANG = {
    'vi': {
        ...
        'amount_prompt': 'Số lượng HAUST (mặc định 0.000001, tối đa 999): ',
        'amount_unit': 'HAUST',
    ...
    'en': {
        ...
        'amount_prompt': 'Amount of HAUST (default 0.000001, max 999): ',
        'amount_unit': 'HAUST',
    ...
    for attempt in range(CONFIG['MAX_RETRIES']):
        try:
            ...
            if balance < required_balance:
                print(f"{Fore.RED}  ✖ {LANG[language]['insufficient_balance'].format(required=required_balance)}: {balance:.6f} HAUST{Style.RESET_ALL}")
                return False
